...
namespace View.Servicecs
{
    public class ShippingUnitServices : IShippingUnitServices
    {
        ...
        {
            await _httpClient.DeleteAsync($"https://localhost:7170/api/ShippingUnits/{shippingUnitId}");
        }
        ...
        {
            var response = await _httpClient.GetStringAsync($"https://localhost:7170/api/ShippingUnits/{shippingUnitId}");
